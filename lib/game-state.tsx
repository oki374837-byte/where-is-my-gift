...
export function GameStateProvider({ children }: { children: React.ReactNode }) {
  ...
  const { mutate: saveProgress } = trpc.game.saveProgress.useMutation();
  ...
  const value = useMemo(() => ({ state, hydrated, collectQuest, recordLocation, addItem, spendCoins, consumeItem, removeItem, resetGame }), [state, hydrated, collectQuest, recordLocation, addItem, spendCoins, consumeItem, removeItem, resetGame]);
