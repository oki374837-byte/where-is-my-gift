...
import { getInventoryTotal, INVENTORY_CAPACITY, ITEM_CATALOG } from "@/lib/item-catalog";
...
export default function StoreScreen() {
  ...
  const buy = (item: (typeof ITEM_CATALOG)[number]) => {
    if (getInventoryTotal(owned) >= INVENTORY_CAPACITY) {
      setNotice("المخزون ممتلئ؛ استخدم أو احذف عنصراً أولاً");
      return;
    }
