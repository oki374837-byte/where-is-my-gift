      ...
      <Modal visible={visible} transparent animationType="slide" onRequestClose={() => setVisible(false)}>
        <View style={styles.overlay}>
          <View style={styles.modalCard}>
            ...
            <Text style={styles.updateHint}>يفتح رابط APK صفحة البناء المنشور فقط، ويؤكد اللاعب التثبيت من نظام Android يدوياً. أما Google Play فيعمل بعد نشر التطبيق هناك؛ لا يوجد تثبيت صامت من داخل اللعبة.</Text>
          </View>
        </View>
      </Modal>
    </>
